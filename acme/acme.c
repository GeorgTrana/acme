...
// 	if(tagcols[BACK] == nil) {
// 		/* Blue */
// 		textcols[BACK] = allocimagemix(display, DPalebluegreen, DWhite);
// 		textcols[HIGH] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, DPalegreygreen);
// 		textcols[BORD] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, DPurpleblue);
// 		textcols[TEXT] = display->black;
// 		textcols[HTEXT] = display->black;
//
// 		/* Yellow */
// 		tagcols[BACK] = allocimagemix(display, DPaleyellow, DWhite);
// 		tagcols[HIGH] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, DDarkyellow);
// 		tagcols[BORD] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, DYellowgreen);
...
//	if(tagcols[BACK] == nil) {
//		/* Blue */
//		textcols[BACK] = allocimagemix(display, DBlack, DBlue);
//		textcols[HIGH] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, DPalegreygreen);
//		textcols[BORD] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, DPurpleblue);
